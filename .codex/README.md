...
Codex handles **W-06〜W-10** of the W-flow (see `docs/how-to/workflow/whole_workflow.md`):
...
> Skills are generated from `agent-tools/skills/`.
> Do not hand-edit generated Skills under `.codex/skills/`.
...
| `/progress`  | Shared     | 3-axis project audit                                                            |
...
2. Codex reads `.codex/skills/implement/SKILL.md` (this Skill)
