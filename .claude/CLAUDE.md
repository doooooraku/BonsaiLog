...
4. **Read `.claude/recurrence-prevention.md` for behavioral rules (R-1〜R-24)** — 必読、行動 lesson。**3 回再発で hook / ESLint / CI に昇華必須** (CLAUDE.md §9 / 記憶の昇華ルール)、`scripts/docs-lint.mjs` で 250 行上限を自動検出
