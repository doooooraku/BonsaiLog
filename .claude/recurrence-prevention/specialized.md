# 再発防止プロトコル — 専門ルール (R-13 〜 R-68)

> 本ファイルは `.claude/recurrence-prevention.md` (親) の詳細部分。
> 親ファイル = R-1 〜 R-12 全文 + R-13 〜 R-68 索引 + 運用ルール。
> 本ファイル = R-13 〜 R-68 詳細記述。
...
## R-68 件数分岐 hook の UI 表現契約 SoT 化 (Sess83 ADR-0025 起票)
...
- 親ファイル: `.claude/recurrence-prevention.md` (R-1 〜 R-12 全文 + R-13 〜 R-68 索引 + 運用ルール)
