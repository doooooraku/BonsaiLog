...
| **R-40** | i18n 翻訳適用前の glossary.md Read 義務 | 翻訳適用 PR 着手前に `docs/reference/glossary.md` を必読、翻訳禁止 15 語 (bonsai/nebari/jin 等) を厳守。`scripts/i18n/apply-translation.mjs --glossary` で違反 warn。Sess20 ADR-0033 D3 由来。詳細: `recurrence-prevention/specialized.md` |
