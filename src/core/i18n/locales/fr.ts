...
const fr: Partial<Record<TranslationKey, string>> = {
  ...
  exportPdfFooterNote: 'Généré par BonsaiLog',
  ...
  exportListPdfListSection: 'Liste de bonsaïs',
  exportListPdfStatsSection: 'Statistiques',
  exportListPdfTotal: "Total d'événements : {count}",
  ...
  settingsVersionSection: 'À propos',
