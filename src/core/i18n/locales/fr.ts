...
const fr: Partial<Record<TranslationKey, string>> = {
  ...
  bonsaiFieldStyleSearchPlaceholder: 'Rechercher par nom de style',
  bonsaiPlaceholderSpecies: 'Sélectionner une espèce',
  bonsaiPlaceholderStyle: 'Sélectionner un style',
