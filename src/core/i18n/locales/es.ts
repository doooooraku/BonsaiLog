...
const es: Partial<Record<TranslationKey, string>> = {
  ...
  exportPdfFooterNote: 'Generado por BonsaiLog',
  ...
  exportListPdfListSection: 'Lista de bonsáis',
  exportListPdfStatsSection: 'Estadísticas',
  exportListPdfTotal: 'Eventos totales: {count}',
  ...
  settingsVersionSection: 'Acerca de',
