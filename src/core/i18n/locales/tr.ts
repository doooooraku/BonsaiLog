...
const tr: Partial<Record<TranslationKey, string>> = {
  ...
  eventDeleteConfirmTitle: 'Bu kaydı sil?',
  eventDeleteConfirmDesc: 'Bu kayıt çöp kutusuna taşınacak. Daha sonra geri yükleyebilirsiniz.',
  ...
  stackWateringDayTitle: 'O günkü sulama',
