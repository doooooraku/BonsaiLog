const baseEn = {
  ...
  bulkScheduleNotifyOn: 'Notify on',
  bulkScheduleNotifyOff: 'No notification',
  bulkScheduleNotifyOnDesc: 'You will be notified on {date} for each bonsai schedule.',
  bulkScheduleNotifyOffDesc: 'Timeline display only. No notification.',
