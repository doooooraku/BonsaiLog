...
const id: Partial<Record<TranslationKey, string>> = {
  ...
  guideRecurringCreateBody:
    'Buat jadwal berulang dari sini. Pilih frekuensi dan tugas mendatang dibuat otomatis.',
  guideNotificationSectionBody:
    'Aktifkan notifikasi di sini dan pilih waktu: satu ringkasan harian pada hari yang ada tugas.',
  ...
  detailTimelinePastCollapsed: 'Catatan lama disembunyikan',
