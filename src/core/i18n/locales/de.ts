...
const de: Partial<Record<TranslationKey, string>> = {
  ...
  exportPdfFooterNote: 'Erstellt mit BonsaiLog',
  ...
  exportListPdfListSection: 'Bonsai-Liste',
  exportListPdfStatsSection: 'Statistik',
  exportListPdfTotal: 'Ereignisse insgesamt: {count}',
