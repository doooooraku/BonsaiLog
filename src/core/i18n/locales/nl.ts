...
const nl: Partial<Record<TranslationKey, string>> = {
  ...
  exportPdfFooterNote: 'Gegenereerd door BonsaiLog',
  ...
  exportListPdfListSection: 'Bonsai-lijst',
  exportListPdfStatsSection: 'Statistieken',
  exportListPdfTotal: 'Totale gebeurtenissen: {count}',
