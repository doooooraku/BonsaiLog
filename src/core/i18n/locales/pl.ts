...
const pl: Partial<Record<TranslationKey, string>> = {
  ...
  exportPdfFooterNote: 'Wygenerowano przez BonsaiLog',
  ...
  exportListPdfListSection: 'Lista bonsai',
  exportListPdfStatsSection: 'Statystyki',
  exportListPdfTotal: 'Wszystkich zdarzeń: {count}',
