...
const ja: Partial<Record<TranslationKey, string>> = {
  ...
  // --- Purchase / Restore ---
  restore: '購入を復元',
  purchaseSuccess: 'Pro プランが有効になりました。',
  ...
  softAskNotifBody:
    'その日の作業予定を、1 日 1 回まとめてお知らせします。通知の時刻はあとで設定から変えられます。',
  ...
  settingsAccountProInactiveDesc: 'プランを確認してアップグレードできます。',
  ...
  paywallFeatureNoAdsFreeValue: '表示あり',
  ...
  exportOptScopeEmptyBody: '盆栽を 1 つ以上選んでください。',
  exportOptTagEmptyBody: 'タグを 1 つ選んでください。',
  ...
  settingsDescFree: 'Pro にアップグレードして、出力・バックアップを無制限に。',
  settingsDescPro: 'BonsaiLog をご支援いただきありがとうございます!',
  settingsViewProPlans: 'Pro プランを見る',
  settingsBenefitNoAds: '広告非表示',
  // --- ADR-0049 Sess59 PR2: Pro 機能 6 項目 (写真 / タグ / 作業記録写真 / カスタム樹種樹形) i18n ---
  paywallFeaturePhoto: '基本情報の写真',
  paywallFeaturePhotoFreeValue: '3 枚まで',
  paywallFeaturePhotoProValue: '無制限',
  paywallFeatureTag: 'タグ',
  paywallFeatureTagFreeValue: '3 個まで',
  paywallFeatureTagProValue: '無制限',
  paywallFeatureWorkLogPhoto: '作業記録の写真',
  paywallFeatureWorkLogPhotoFreeValue: '3 枚まで',
  paywallFeatureWorkLogPhotoProValue: '10 枚まで',
  paywallFeatureCustomSpecies: 'カスタム樹種・樹形',
  paywallFeatureCustomSpeciesFreeValue: '3 件まで',
  paywallFeatureCustomSpeciesProValue: '無制限',
  paywallFeatureRecurringRule: '定期予定',
  paywallFeatureRecurringRuleFreeValue: '3 件まで',
  paywallFeatureRecurringRuleProValue: '無制限',
  settingsBenefitPhoto: '基本情報の写真 3 枚 → 無制限',
  settingsBenefitTag: 'タグ 3 個 → 無制限',
  settingsBenefitWorkLogPhoto: '作業記録の写真 3 枚 → 無制限',
  settingsBenefitCustomSpecies: 'カスタム樹種・樹形 3 件 → 無制限',
  settingsBenefitRecurring: '定期予定 3 件 → 無制限',
  ...
  notificationCardHint:
    'これはまとめ通知の時刻です。個別の予定ごとには通知されません。通知を全部止めたい場合は「設定 → 通知」から変更できます。',
  rulePreviewCardTitle: 'このルールで作られる予定',
  rulePreviewCardNextLabel: '次回',
  recurringEditConfirmTitle: 'ルールを更新しますか?',
  recurringEditConfirmBody: '既存の予定 (未実施分) は一旦削除され、新しいルールで作り直されます。',
