...
const zhHans: Partial<Record<TranslationKey, string>> = {
  ...
  backupExportDesc: '将盆景记录、照片和养护历史导出为一个 ZIP 文件。可从共享菜单选择保存位置。',
  ...
  backupEncryptionWarning: '注意：备份不会加密，请自行妥善保管保存位置。',
  ...
  detailTimelinePastCollapsed: '历史记录已折叠',
  ...
  settingsBenefitPhoto: '盆景照片：3 → 无限制',
  settingsBenefitTag: '标签：3 → 无限制',
  settingsBenefitWorkLogPhoto: '工作记录照片：3 → 无限制',
