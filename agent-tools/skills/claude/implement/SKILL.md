...
## やさしい説明
<!-- 専門用語なしで「何を」「なぜ」を 2〜4 文 (PR テンプレ §2.5 と同義、Sess101 #1173)。
     読者想定 = 開発に関わっていない人。チャット報告は揮発するため PR が恒久保存先 -->
- ...
...
### やさしい説明 (REQUIRED — Sess101 #1173)
専門用語を使わずに「何を」「なぜ」直した/作ったかを 2〜4 文で。
たとえ話・図解は歓迎。PR 本文 §2.5 にも同内容を残すこと (チャットは揮発、PR が恒久保存先)。
...
- PR が作成され CI が回っている
- **完了報告 (チャット) と PR 本文 §2.5 の両方に「やさしい説明」がある** (Sess101 #1173 user 決定 — 「コードが merge された」ではなく「オーナーが理解した」までが完了)
