...
| **g3b-bulk-schedule-date (formSheet)** | **3/3 = 100% PASS** | ~3 分        | **採用** | 2026-05-12 Phase G3b で skip-list 永続 1 件 (home-bulk-sched-date) を解消、3/3 達成 — Phase G の主目的達成          |
| **g4-bonsai-new (modal)**              | **3/3 = 100% PASS** | ~2 分        | **採用** | 2026-05-12 Phase G4 part 2 で BonsaiCreate modal 化、3/3 達成 (autoFocus keyboard 問題は scrollUntilVisible で解消) |

**合計: 25/25 = 100% PASS** (Phase G4 part 2 完遂、BonsaiCreate modal 化で functional_spec §6.2 既存設計に整合)
