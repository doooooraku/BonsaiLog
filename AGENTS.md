...
このファイルには「過去に複数回ユーザーから指示された行動パターン」が R-1〜R-57 として構造化されている:
...
- R-13〜R-57: 専門ルール (詳細は `recurrence-prevention/specialized.md` を参照)
  - 例: R-13 (議論モードでの質問数・ラウンド数の予告) / R-22 (Codex 不採用 + docs-lint 構造防止) / R-44 (破壊的アクション pattern) / R-57 (PR マージ時にブランチを都度削除)

**役割分担**:

- `docs/reference/lessons.md` = 技術 lesson（DB / Backup / ビルド等の領域別）
