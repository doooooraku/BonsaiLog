...
この「プロダクト戦略」は、BonsaiLogの**価値**と**スコープ境界**と**判断基準**を固定するための文書です。  
つまり、実装中に迷ったときに「戻ってくる地図」です。

### 0-1. 読むと分かること

- BonsaiLogは**誰のための**何のアプリか
...
- BonsaiLogはUIの気持ちよさ自体がユーザー体験に直結する
- UIの正は **Figma**（仕様書は補助）
