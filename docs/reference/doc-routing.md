...
| i18n          | `src/core/i18n/**`                                                 | `docs/adr/ADR-0033-i18n-translation-policy.md`, `docs/reference/copy-style-ja.md`                                                                                                                                          | 19 言語全 key 揃え (`pnpm i18n:check`)・禁止語 (R-3 reminder 等)・ja 文体基準 (`pnpm i18n:style`、ADR-0060)・英語 fallback 一括 pattern |
