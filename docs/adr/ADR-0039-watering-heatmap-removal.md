...
- glossary: `docs/reference/glossary.md` (ヒートマップ / Skia / ColorBrewer 用語を「廃止」 マーク) ※廃止 — Sess101 #1169 で glossary.md 削除 (用語の正 = basic_spec §2 + constraints + コード、翻訳禁止リストは ADR-0033 D3)
